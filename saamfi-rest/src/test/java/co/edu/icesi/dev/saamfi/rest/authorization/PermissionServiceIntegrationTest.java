...
public class PermissionServiceIntegrationTest {
	 ...
	 */
	@Test
	void testGetRolesAssociatedWithPermissionAdmInt2() {    long instId = 1;    long permissionId = 999999;    List<SaamfiRoleeStdOutDTO> rolesDTO_returned = permissionService.getRolesAssociatedWithPermissionAdm(instId,          permissionId);    assertTrue(rolesDTO_returned.size() == 0);}
	 ...
	 */
	@Test
	void testGetRolesAssociatedWithPermissionOperInt4() {    long instId = 1;    long permissionId = 110;    List<SaamfiRoleeStdOutDTO> rolesDTO_returned = permissionService.getRolesAssociatedWithPermissionOper(instId,          permissionId);    assertTrue(rolesDTO_returned.size() == 0);}
}
